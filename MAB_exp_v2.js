...
const text_after_block = {
    ...
    stimulus: function() {
        ...
        if (block == 30) {// finish
            ...
            text += "一つのカジノで用意されている絵画は全部で<b>5枚</b>であること，そして";
...
const end_exp2 = {
    ...
    stimulus: function() {
        ...
        text += "<b>「実験URLをお送りしたメール」に返信する形</b>で，実験実施者まで伝えてください。<br>";
        text += "全体へのメールではなく，<b>必ず個別のスレッドで返信する</b>よう，お願いいたします。<br>";
